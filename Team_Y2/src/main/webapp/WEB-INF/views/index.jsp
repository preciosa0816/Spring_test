			...
			<section id="cont_left">
				...
				<article class="column col1">
					...
					<div class="menu">
						<ul>
							...
							<li><a href="/boardList">소장 도서관리 <i
									class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
							<li><a href="#">예약 도서관리 <i
									class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
							<li><a href="/wish/guide">희망 도서관리 <i
									class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
							<li><a href="#">추천 도서관리 <i
									class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
							<li><a href="#">열람실 관리 <i
									class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
							<li><a href="#">공지사항 <i class="fa fa-angle-double-right"
									aria-hidden="true"></i></a></li>
							<li><a href="/forum/list">자유 게시판 <i
									class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
							<li><a href="#">Q&A 게시판 <i
									class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
						</ul>
				...
				<article class="column col3">
					...
					<div class="blog1">
						...
						<figure>
							<img src="resources/html/img/blog4_@1.jpg" class="img-normal"
								alt="normal image">
							<img src="resources/html/img/blog4_@2.jpg" class="img-retina"
								alt="retina image">
			...
			<section id="cont_center">
				...
				<article class="column col5">
					...
					<div class="lightbox square clearfix">
						<a href="resources/html/img/light01_s.jpg"><img
							src="resources/html/img/light01.jpg" alt="이미지"><em>blur</em></a>
						<a href="resources/html/img/light02_s.jpg"><img
							src="resources/html/img/light02.jpg" alt="이미지"><em>brightness</em></a>
						<a href="resources/html/img/light03_s.jpg"><img
							src="resources/html/img/light03.jpg" alt="이미지"><em>contrast</em></a>
						<a href="resources/html/img/light04_s.jpg"><img
							src="resources/html/img/light04.jpg" alt="이미지"><em>grayscale</em></a>
						<a href="resources/html/img/light05_s.jpg"><img
							src="resources/html/img/light05.jpg" alt="이미지"><em>hue-rotate</em></a>
						<a href="resources/html/img/light06_s.jpg"><img
							src="resources/html/img/light06.jpg" alt="이미지"><em>invert</em></a>
						<a href="resources/html/img/light07_s.jpg"><img
							src="resources/html/img/light07.jpg" alt="이미지"><em>opacity</em></a>
						<a href="resources/html/img/light08_s.jpg"><img
							src="resources/html/img/light08.jpg" alt="이미지"><em>saturate</em></a>
						<a href="resources/html/img/light09_s.jpg"><img
							src="resources/html/img/light09.jpg" alt="이미지"><em>sepia</em></a>
						<a href="resources/html/img/light10_s.jpg"><img
							src="resources/html/img/light10.jpg" alt="이미지"><em>Mix</em></a>
					</div>
					<!--//lightbox -->
				</article>
				<!-- //col5 -->
				...
				<article class="column col6">
					...
					<div class="video">
						<iframe width="560" height="315"
							src="https://www.youtube.com/embed/akJu8OLkiI8" frameborder="0"
