...
<script>
	...
	$(document).ready(function() {
		...
		(function(){//즉시실행 함수를 이용하여 첨부파일의 데이터를 가져오는 부분을 처리 <첨부파일 확인하는 부분>
			...
			$.getJSON("/mypage/myforumgetAttachList", {fno:fno}, function(arr){
				console.log(arr);
		...
		$('button').on("click", function(e) {
			...
			if (operation === 'remove') {
				formObj.attr("action", "/mypage/myforumremove");
			} else if (operation === 'list') {
				//move to list
				formObj.attr("action","/mypage/myforum").attr("method","get");
				...
				formObj.append(user_id);
				
			}else if (operation==='modify'){
				if(!formObj.find("#pcatagory option:selected").val()){
					alert("카테고리를 입력하세요");
					return false;
				}
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">자유게시글 수정</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">나의 자유게시글 수정페이지</div>
			<!-- /.panel-heading -->
			<div class="panel-body">
				
				<form role="form" action="/mypage/myforummodify" method="post">
					...
					<div class="form-group">
						...
						<label>카테고리</label> <select name="pcatagory" id="pcatagory">
