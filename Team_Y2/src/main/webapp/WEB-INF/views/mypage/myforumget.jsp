...
<%@include file="../includes/index_header.jsp"%>p"%>
								...
								var check = '<c:out value="${forum.user_id}"/>';
									...
									for (var i = 0, len = list.length || 0; i < len; i++) {
										...
										str += "<div><div class='header'><strong class='primary-font'>["
												+ list[i].rno+"] "+list[i].replyer+"<img width='30px' height='30px' src='/resources/img/writer.png'>"+ "</strong>";
										}else{
											str += "<div><div class='header'><strong class='primary-font'>["
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("button[data-oper='modify']").on("click", function(e) {
			operForm.attr("action", "/mypage/myforummodify").submit();
		});
		$("button[data-oper='delete']").on("click", function(e) {
			operForm.attr("action", "/mypage/myforumremove").attr("method","post").submit();
		}); 
		$("button[data-oper='list']").on("click", function(e) {
			operForm.find("#bno").remove();
			operForm.attr("action", "/mypage/myforum");
			var user_id="<input type='hidden' name='user_id' value='<c:out value="${forum.user_id}"/>'>";
			operForm.append(user_id);
			operForm.submit();
		});
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">내가 쓴 게시글읽기</div>
			<!-- /.panel-heading -->
			...
			<table>
				...
				<tr>
					...
					<td><input class="form-control" name="pcatagory" 
						value='<c:out value="${forum.pcatagory}"/>' readonly="readonly"></td>
