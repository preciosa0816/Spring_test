...
//	}
	...
	@PreAuthorize("principal.username == #board.writer") //문자열로 표현식지정가능. 로그인한 사용자와 현재 파라미터로 전달되는 작성자 일치확인.
	@PostMapping("/modify") 
...
//		return "redirect:/board/list";
	...
	@PreAuthorize("principal.username == #writer") //문자열로 표현식지정가능. 로그인한 사용자와 현재 파라미터로 전달되는 작성자 일치확인.
	@PostMapping("/remove") 
