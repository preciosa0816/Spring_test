	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="row">
				<div class="col-lg-12">
				<form id='searchForm' action="/wish/wishlist_state" method="get">
 					<select name='type'> 
						<option value="ACPHI" 
						...
						<c:out value="${pageMaker.cri.type eq 'P'?'selected':''}"/>>주문진행중</option>
 						<option value="H" 
						<c:out value="${pageMaker.cri.type eq 'H'?'selected':''}"/>>취소:도서소장중</option>
 						<option value="I" 
						<c:out value="${pageMaker.cri.type eq 'I'?'selected':''}"/>>취소:부적합한 도서</option>
 						<option value="T" 
