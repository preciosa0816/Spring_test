	...
	$(document).ready(function() {
		...
		$('button').on("click", function(e) {
			...
			if (operation === 'remove') {
				...
				//move to list
				formObj.attr("action","/wish/wishlist_state").attr("method","get");
				...
				if(!formObj.find("#progress option:selected").val()){
					alert("처리결과를 입력하세요");
					return false;
				}
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">wishlist Modify Page</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">wishlist Modify Page</div>
			<!-- /.panel-heading -->
			<div class="panel-body">
				...
				<form role="form" action="/wish/modify" method="post">
					...
					<input type='hidden' name="wno" value="<c:out value='${wishlist.wno}'/>">
					<input type='hidden' name="user_id" value="<c:out value='${wishlist.user_id}'/>">
				...
				<tr>
					...
					<td><input name="pubyear"  width="500px"
						value='<fmt:formatDate pattern="yyyy/MM/dd"
									value="${wishlist.pubyear }" />' readonly="readonly"></td>
				...
				<tr>
					...
					<td colspan="3"><textarea rows='3' name='comments' cols="95"
						><c:out value="${wishlist.comments}"/></textarea></td>				
				</tr>
				<tr>
					<td width="30%;"><label>처리결과</label></td>
					<td colspan="3"><select name="progress" id="progress">
													<option value="">처리결과 선택</option>
													<option value="도서확인중">도서확인중</option>
													<option value="주문진행중">주문진행중</option>
													<option value="취소:도서소장중">취소:도서소장중</option>
													<option value="취소:부적절한도서">취소:부적절한도서</option>
